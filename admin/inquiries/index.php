                ...
                ?>
                    <tr>
                        ...
                        <td class="text-center status">
                            <?php if($row['status'] == 0): ?>
                                <span class="badge badge-warning">Belum di baca</span>
                            <?php elseif($row['status'] == 1): ?>
                                <span class="badge badge-success">Sudah di baca</span>
                            <?php endif; ?>
                        </td>
                        <td align="center">
                                ...
                                <a class="dropdown-item view_data" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>"><span class="fa fa-file text-primary"></span> Lihat</a>
...
<script>
	...
	function delete_inquiry($id){
		start_loader();
		$.ajax({
			url:base_url+"classes/Master.php?f=delete_inquiry",
			method:"POST",
			data:{id: $id},
			dataType:"json",
			error:err=>{
